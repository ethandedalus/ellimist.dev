...
In the next post, we will extend the ideas of single decree Paxos to multi decree Paxos and cover how a replicated state machine can work in a fault tolerant way.
